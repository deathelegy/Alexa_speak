...
var ReadEmail = require("./ReadEmail.js");
var SendEmail = require("./SendEmail.js");
var ReadCalendar = require("./ReadCalendar.js");
var BookMeeting = require("./BookMeeting.js");
var AddContact = require("./AddContact.js");
 ...
 */
 var speechOutput;
 var reprompt;
 var welcomeOutput = "welcome assign task service, what do you want to do?";
...
function getWelcomeResponse(callback) {
    ...
    const speechOutput = 'welcome assign task service, what do you want to do?';
    // If the user either does not reply to the welcome message or says something that is not
    // understood, they will be prompted again with this text.
    const repromptText = "welcome assign task service, what do you want to do?";
...
function onIntent(request, session, callback) {
    ...
    if (intentName === 'AssignTask') {
        AssignTask.AssignTask(request, session, callback);
    }else if(intentName === 'SendMessage'){
          SendMessage.SendMessage(request, session, callback);
    }else if(intentName === 'SignUp'){
          SignUp.SignUp(request, session, callback);
    }else if(intentName === 'ReadEmail'){
          ReadEmail.ReadEmail(request, session, callback);
    }else if(intentName === 'SendEmail'){
          SendEmail.SendEmail(request, session, callback);
    }else if(intentName === 'ReadCalendar'){
          ReadCalendar.ReadCalendar(request, session, callback);
    }else if(intentName === 'BookMeeting'){
          BookMeeting.BookMeeting(request, session, callback);
    }else if(intentName === 'AddContact'){
          AddContact.AddContact(request, session, callback);
